...
abstract class $AppRouter extends _i65.RootStackRouter {
  ...
  final Map<String, _i65.PageFactory> pagesMap = {
    ...
    MegaKassaEntryRoute.name: (routeData) {
      return _i65.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i24.MegaKassaEntryScreen(),
      );
    },
...
class MegaKassaEntryRoute extends _i65.PageRouteInfo<void> {
  const MegaKassaEntryRoute({List<_i65.PageRouteInfo>? children})
      : super(
