...
@RoutePage()
class BlackListCameraScreen extends StatefulWidget {
  const BlackListCameraScreen({
    Key? key,
  ...
  @override
  State<BlackListCameraScreen> createState() => _BlackListCameraScreenState();
}

class _BlackListCameraScreenState extends State<BlackListCameraScreen>
