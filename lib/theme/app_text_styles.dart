...
abstract class AppTextStyles {
  static TextStyle s7Bold({Color? color}) => TextStyle(
  ...
  static TextStyle s10W600({Color? color}) => TextStyle(
        color: color ?? Colors.black,
        fontSize: 10,
  ...
  static TextStyle s12W600({Color? color}) => TextStyle(
        color: color ?? Colors.black,
        fontSize: 12,
        fontWeight: FontWeight.w600,
      );
  static TextStyle s13W500({Color? color}) => TextStyle(
        color: color ?? Colors.black,
        fontSize: 13,
        fontWeight: FontWeight.w500,
      );
  static TextStyle s13W400({Color? color}) => TextStyle(
        color: color ?? Colors.black,
        fontSize: 13,
        fontWeight: FontWeight.w400,
      );
  ...
  static TextStyle s18W400({Color? color}) => TextStyle(
        fontSize: 18,
        fontWeight: FontWeight.w400,
        color: color ?? Colors.black,
      );
  ...
  static TextStyle s20W600({Color? color}) => TextStyle(
        fontSize: 20,
        fontWeight: FontWeight.w600,
        color: color ?? Colors.black,
      );
